 ...
 * @date July 27 2021
 *
 * This file handles the blueprint for generating the population and other
 * methods required.
 */
...
int getRaceInput();
void getHouseholdInformationInput(int *size, int *seniors,
                                  int *adultsWithChronicDiseases);
int getHouseholdCovidInformationInput(int size, int *tested,
                                      int *testedPositive);
